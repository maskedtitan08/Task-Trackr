...
export default function LoginView() {
  return (
    <div className="flex flex-col md:flex-row h-screen">
      <div className="flex-1 bg-[#dfe4fe] flex items-center justify-center p-5">
        <img src="/task.jpeg" className="w-full h-auto max-w-full max-h-full object-cover" alt="Task" />
      </div>
      <div className="flex-1 bg-[#dfe4fe] flex flex-col items-center justify-center p-5">
        <h1 className="text-3xl md:text-5xl font-bold mb-6 text-center">
          Hello,<br /> Welcome back
        </h1>
        <button
          onClick={() => signIn('google')}
          className="bg-[#dfe4fe] rounded-2xl border-2 border-[#4A5696] p-3 md:p-4 flex items-center text-lg md:text-2xl"
        >
